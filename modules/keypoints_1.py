...
BODY_PARTS_KPT_IDS = [[1,8], [1,2], [1,5], [2,3], [3,4], [5,6], [6,7],
                      [8,9], [9,10], [10,11], [8,12], [12,13], [13,14],
                      [1,0], [0,15], [15,17], [0,16], [16,18], [2,17], [5,18],
                      [14,19], [19,20], [14,21], [11,22], [22,23], [11,24]]
BODY_PARTS_PAF_IDS = ([0,1], [14,15], [22,23], [16,17], [18,19], [24,25], [26,27],
                      [6,7], [2,3], [4,5], [8,9], [10,11], [12,13],
                      [30,31], [32,33], [36,37], [34,35], [38,39], [20,21], [28,29],
...
def extract_keypoints(heatmap, all_keypoints, total_keypoint_num):
    ...
    map_shape = heatmap_with_borders.shape
    heatmap_center = heatmap_with_borders[1:map_shape[0]-1, 1:map_shape[1]-1]
    heatmap_left = heatmap_with_borders[1:map_shape[0]-1, 2:map_shape[1]]
    heatmap_right = heatmap_with_borders[1:map_shape[0]-1, 0:map_shape[1]-2]
    heatmap_up = heatmap_with_borders[2:map_shape[0], 1:map_shape[1]-1]
    heatmap_down = heatmap_with_borders[0:map_shape[0]-2, 1:map_shape[1]-1]
