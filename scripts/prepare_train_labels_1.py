...
if __name__ == '__main__':
    with open('coco/annotations/body25_train2017.json', 'r') as f:
        data = json.load(f)
    ...
    prepared_annotations = prepare_annotations(annotations_per_image_mapping, images_info, 368)

    with open('data/prepared_train_annotation_1.pkl', 'wb') as f:
