...
* `python train.py --checkpoint-path body25_checkpoints/checkpoint_iter_420000.pth --weights-only --num-workers 6 --batch-size 80 --batches-per-iter 1`
* `python train.py --checkpoint-path body25_checkpoints/checkpoint_iter_280000.pth --weights-only --num-refinement-stages 3 --num-workers 6 --batch-size 80 --batches-per-iter 1`
